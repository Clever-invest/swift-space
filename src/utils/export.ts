...
export function exportToCSV(
  ...
  const rows = [
    ...
    ['Доля Swift Space (%)', input.operatorProfitSharePct],
    ['', ''],
    ['=== МЕТРИКИ ПРОЕКТА ===', ''],
...
<body>
  <div class="container">
    ...
    <div class="section">
      ...
      <table>
        <tr><th></th><th>Инвестор (${fmtPct(input.investorProfitSharePct)})</th><th>Swift Space (${fmtPct(input.operatorProfitSharePct)})</th></tr>
        <tr>
          <td>Капитал</td>
    ...
    <div class="methodology">
      ...
      <p><strong>Сплит прибыли:</strong> Инвестор финансирует все затраты и получает возврат капитала + свою долю прибыли. Swift Space получает только свою долю прибыли.</p>
    </div>
  </div>
</body>
</html>
